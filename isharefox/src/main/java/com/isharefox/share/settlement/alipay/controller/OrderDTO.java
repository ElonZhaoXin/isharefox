...
public class OrderDTO {
		...
		public LocalDateTime getNotify_time() {
			return notify_time;
		}
		public void setNotify_time(LocalDateTime notify_time) {
		...
		public LocalDateTime getGmt_payment() {
			return gmt_payment;
		}
		public void setGmt_payment(LocalDateTime gmt_payment) {
			this.gmt_payment = gmt_payment;
		}
		public LocalDateTime getGmt_refund() {
			return gmt_refund;
		}
		public void setGmt_refund(LocalDateTime gmt_refund) {
		...
		public String toString() {
			return "OrderDTO [notify_time=" + notify_time + ", notify_type=" + notify_type + ", notify_id=" + notify_id
					+ ", sign_type=" + sign_type + ", sign=" + sign + ", trade_no=" + trade_no + ", app_id=" + app_id
					...
					+ refund_fee + ", send_back_fee=" + send_back_fee + ", subject=" + subject + ", body=" + body
					+ ", gmt_create=" + gmt_create + ", gmt_payment=" + gmt_payment + ", gmt_refund=" + gmt_refund
					+ ", gmt_close=" + gmt_close + ", fund_bill_list=" + fund_bill_list + "]";
		}
}
